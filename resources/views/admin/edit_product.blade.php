                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_quantity" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_quantity }}" required="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slug</label>
                            <input type="text" name="product_slug" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_slug }}" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $pro->price_cost }}" name="price_cost" class="form-control" id="exampleInputEmail1" required="">
                        </div>
                        <div class="form-group">
